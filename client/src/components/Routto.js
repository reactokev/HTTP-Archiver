...
class Routto extends Component {
  ...
  render() {
    ...
    <p ><i>Enter the URL</i> <span><input style={{width:'50%',padding:5}}  type="text" value={this.state.value} placeholder='format: https|http://facebook.com/login' onChange={this.handleChange} /><button style={{padding:5}} onClick={() => this.handleSubmit(this.state.value)} value="Submit">Submit</button></span></p>
    </div>
