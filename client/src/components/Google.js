...
class Google extends Component {
  ...
  urlPost = () => {
        fetch('http://localhost:3000/api/post/google', {headers: new Headers({
  ...
  render() {
    ...
    <p ><i>Google Search</i> <span><input style={{width:200,padding:5}}  type="text" value={this.state.value} placeholder='ex: Taylor Swift' onChange={this.handleChange} /><button style={{padding:5}} onClick={() => this.handleSubmit(this.state.value)} value="Submit">Search</button></span></p>
    </div>
    ...
    <div style={{display:'flex',flexDirection:'row',marginTop:10}}>
        <div style={{flex:1,marginLeft:10,marginRight:10,width:'50%',border:"solid",borderWidth:.3,borderColor:'gray',boxShadow:'0.5px 0.5px 0.5px 0.5px #888888'}}>
            ...
            <p>Please enter a search content</p>
            </div>
            }
        </div>
